...
When the budget runs out the round records the failure and carries on: failing the node would
skip every role downstream, which is not what a failed check means.
