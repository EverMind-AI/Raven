...
- dispatch-compat lives in test_rpc_cli_dispatch.py
"""
...
from raven.rpc.methods.commands import commands_catalog
...
async def test_skill_count_propagated_to_response(monkeypatch) -> None:
    ...
    """
    from raven.rpc.methods import commands
...
def test_catalog_filter_uses_dispatch_blacklist_constant() -> None:
    ...
    """
    from raven.rpc.methods import cli_dispatch, commands
