...
from raven.tui_rpc.methods import console as console_module
from raven.tui_rpc.methods.console import _SETTINGS_SIMPLE_KEYS, _hub_marker_name
...
def test_the_hub_marker_is_none_when_the_market_is_absent(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def _no_skillhub(name, *args, **kwargs):
        if name == "raven.tui_rpc.methods.skillhub":
...
async def test_the_gateway_registers_what_the_umbrella_does() -> None:
    ...
    import raven.tui_rpc.bootstrap as bootstrap_module
...
async def test_fs_read_still_serves_the_head_of_a_file_past_the_ceiling(
    ...
    """
    from raven.tui_rpc import files as files_module
