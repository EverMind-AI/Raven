...
_STUB_CASES = [
    ...
    # ``raven.rpc.methods.commands`` (harness-command-catalog-dynamic);
    # its parity test is ``tests/test_rpc_commands_catalog.py``.
    # image.attach
