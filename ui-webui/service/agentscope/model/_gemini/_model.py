...
from typing import TYPE_CHECKING, Any, AsyncGenerator, List, Literal, Type

from pydantic import BaseModel, Field

from ..._utils._common import _flatten_json_schema, _generate_id
...
from .._base import _TOOL_CHOICE_LITERAL_MODES, ChatModelBase
