...
import List from '~icons/solar/list-bold-duotone';
		...
		<div className="w-full h-full flex flex-col bg-sidebar overflow-hidden">
			<div className="flex items-center justify-between p-4 flex-shrink-0">
				<div className="flex flex-col gap-0.5">
					<div className="em-kicker">{t('schedule.kicker')}</div>
					<span className="text-2xl font-medium">
						<span className="em-accent">{t('common.schedule')}</span>
					</span>
				</div>
			...
			<div className="flex-1 overflow-hidden rounded-t-3xl bg-background">
				{viewMode === 'calendar' && (
					<CalendarTabPage
						events={events}
