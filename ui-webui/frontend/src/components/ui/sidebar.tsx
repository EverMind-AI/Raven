...
import PanelLeftIcon from '~icons/solar/siderbar-linear';
...
function SidebarMenu({ className, ...props }: React.ComponentProps<'ul'>) {
	return (
		<ul
			...
			data-sidebar="menu"
			className={cn('flex w-full min-w-0 flex-col gap-y-1', className)}
			{...props}
		/>
	);
}
