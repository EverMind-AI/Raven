...
Vendored verbatim from the official reference implementation shipped with
deepseek-ai/DeepSeek-V4-Flash-0731 (HF repo, encoding/ folder). Keep diffs
against upstream to zero; wrap, do not edit. Consumed by
