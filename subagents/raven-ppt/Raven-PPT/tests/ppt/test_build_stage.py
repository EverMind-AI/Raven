...
from raven.ppt.contracts import BuildOutcome, Finding, PageSource, Project, Severity
...
def _house_of(project: Project, path: Path, pages: int) -> str:
    from raven.ppt.stages.build import _deck_house
...
def test_the_record_travels_on_the_note_the_reply_already_carries(project: Project) -> None:
    ...
    from raven.ppt.stages.build import _with_deck_house
