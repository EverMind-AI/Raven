...
from raven.ppt.services.ingest import ingest_materials, sources
...
class PptGenerateImageTool(Tool):
    ...
    description = (
        ...
        "that does not already exist; use web_search(kind='images') and ppt_fetch for a real logo, product "
