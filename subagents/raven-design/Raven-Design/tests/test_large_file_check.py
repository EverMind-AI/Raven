...
def test_allows_only_jpg_skill_reference_images(tmp_path: Path) -> None:
    paths = [
        "raven/memory_engine/skills/example/references/benchmark.jpg",
        "raven/memory_engine/skills/example/references/nested/benchmark.jpg",
        "raven/memory_engine/skills/example/references/benchmark.png",
        "raven/memory_engine/skills/example/assets/benchmark.jpg",
        "raven/skills/example/references/benchmark.jpg",
        "docs/benchmark.jpg",
    ]
    for path in paths:
    ...
    assert violations == [
        check_large_files.BlockedAssetViolation(
            path="raven/memory_engine/skills/example/references/benchmark.png",
            extension=".png",
        ),
        check_large_files.BlockedAssetViolation(
            path="raven/memory_engine/skills/example/assets/benchmark.jpg",
            extension=".jpg",
        ),
        check_large_files.BlockedAssetViolation(
            path="raven/skills/example/references/benchmark.jpg",
            extension=".jpg",
        ),
...
def test_skill_reference_images_still_obey_size_limit(tmp_path: Path) -> None:
    path = "raven/memory_engine/skills/example/references/benchmark.jpg"
    candidate = tmp_path / path
