...
from raven.memory_engine.skill_forge.visual_domain_selector import VISUAL_DOMAIN_SKILL_NAMES
...
def _registry(tmp_path: Path) -> SkillRegistry:
    return SkillRegistry(tmp_path / "workspace")
...
def test_visual_domain_skills_are_packaged_with_resolvable_references(
    ...
    assert by_name["visual-artifact-design"].source == "builtin"
