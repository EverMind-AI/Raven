...
- Packaged `.jpg` benchmark plates under `raven/memory_engine/skills/<skill>/references/` are functional Skill inputs, not report assets, and are allowed. The 1 MiB limit still applies.
