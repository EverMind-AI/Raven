...
def register(app: typer.Typer) -> None:
    ...
    def agent(
        ...
        agent_loop = AgentLoop(
            ...
            context_compaction_config=config.agents.defaults.context_compaction,
            ...
            task_state_enabled=config.tools.task_state.enabled,
            render_config=config.tools.render,
        ...
        flush_and_hard_exit(_ONE_SHOT_EXIT["code"])
