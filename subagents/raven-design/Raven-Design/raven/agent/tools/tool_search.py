...
from raven.agent.tools.base import Tool, ToolOutput
...
class ToolSearchController:
    ...
    async def call(self, name: str, arguments: dict[str, Any] | None) -> ToolOutput | str:
...
class ToolCallTool(Tool):
    ...
    async def execute(self, name: str, arguments: dict[str, Any] | None = None) -> ToolOutput | str:
