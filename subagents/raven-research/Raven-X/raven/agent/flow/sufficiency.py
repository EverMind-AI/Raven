...
from raven.agent.harness_text import harness_body_kind, sufficiency_notice
...
class SufficiencyGate(AgentHook):
    ...
    async def after_iteration(self, ctx: AgentHookContext) -> HookDecision:
        ...
        outcome = "fail_open" if verdict is None else (
            "sufficient" if verdict.get("sufficient") else "insufficient"
        )
