...
class SessionManager:
    ...
    def partial_path(self, key: str) -> Path:
        """Sidecar path for the crash-durable turn journal: a surviving
        ``.partial.jsonl`` marks a turn that was killed before ``save``."""
        return self._get_session_path(key).with_suffix(".partial.jsonl")
