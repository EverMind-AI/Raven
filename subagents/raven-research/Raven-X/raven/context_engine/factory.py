...
def build_context_engine(
    *,
    ...
    extra_segment_builders: "list | None" = None,
    drop_segments: "frozenset[str] | None" = None,
) -> ContextEngine:
    ...
    if drop_segments:
        builders = [b for b in builders if b.name not in drop_segments]
    if extra_segment_builders:
        builders.extend(extra_segment_builders)
