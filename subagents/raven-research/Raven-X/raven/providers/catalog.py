...
def describe(provider: str, model: str) -> ModelRow:
    ...
    """
    from raven.providers.registry import canonical_provider_name, split_model_id
    ...
    return ModelRow(ref=ref, provider=provider, label=split_model_id(ref)[1] or ref, source=SOURCE_ID_ONLY)
