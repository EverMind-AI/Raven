...
def _point_oauth_tokens_at_raven() -> None:
    ...
    """
    from raven.config.paths import ensure_oauth_dir

    oauth_home = ensure_oauth_dir()
    os.environ.setdefault("GITHUB_COPILOT_TOKEN_DIR", str(oauth_home / "github_copilot"))
    os.environ.setdefault("CHATGPT_TOKEN_DIR", str(oauth_home / "chatgpt"))
