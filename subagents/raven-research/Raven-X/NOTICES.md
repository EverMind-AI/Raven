...
## models.dev (bundled model-catalogue snapshot)
- Source: https://github.com/anomalyco/models.dev
- Copyright (c) 2025 models.dev
- License: MIT — see `LICENSES/MIT-models-dev.txt`
- Scope: `raven/providers/data/models_dev.json` is a trimmed snapshot of the
  models.dev catalogue (labels, descriptions, per-model cost), regenerated by
  `scripts/refresh_models_dev_snapshot.py`; the pinned source commit is
  recorded in the file's `_source` key. Data only — no models.dev code is
  vendored.
