...
- Scope: hermes-agent ships its own fork of community ink at
  ...
  ink converges / patch debt > 500 LOC) were tracked in upstream Raven's
  internal notes, which are not part of this repository.
...
- Fallback contingency: if upstream maintenance halts (>90 days no push) or
  a severe incompatibility surfaces, the vendor-or-pivot ladder lived in
  upstream Raven's internal notes, which are not part of this repository.
  Vendoring would require moving
