...
def test_slack_transient_classifier(code, expected):
    ...
    # slack_sdk ships with the optional channel extras, absent in this DR-only
    # fork; skip rather than fail all three parametrisations.
    pytest.importorskip("slack_sdk", reason="optional channel extras not installed")
