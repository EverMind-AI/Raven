...
# boxlite lives in the optional `sandbox` extra, which this DR-only fork does not
# install; skip instead of failing all 15. Do not install it - this venv is the
# one the evaluation subprocesses import from.
