...
def test_exactly_five_concrete_backend_classes() -> None:
    # This asserts class existence only, not the dispatch wiring. Upstream also
    # carries PerModelProvider (conversation-scoped model binding); that
    # subsystem is not ported to this build.
