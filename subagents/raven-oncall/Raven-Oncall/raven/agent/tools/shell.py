...
class ExecTool(Tool):
    ...
    def description(self) -> str:
        # Two descriptions, because the second sentence is a lie for an owner who
        # registered no machines: it names ops_connections and ops_submit, which
        # such an instance does not even have. Read per call rather than fixed at
