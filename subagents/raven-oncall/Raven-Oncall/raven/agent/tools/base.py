...
class Tool(ABC):
    ...
    def ends_turn(self) -> bool:
        """True when calling this tool means the turn itself is finished.
        ...
        The loop honours this by offering no tools on the next call, so the model
        can still write its closing message but cannot start another step.
        """
        return False
