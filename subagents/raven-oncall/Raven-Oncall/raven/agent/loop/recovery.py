...
EMPTY_RETRY_NUDGE = (
    "Your last response contained no answer and no tool call. That can happen "
    "when reasoning uses the entire token budget. Answer briefly, or make one "
    "tool call, and keep any reasoning short."
)
...
class RecoveryAction(Enum):
    ...
    RETRY = auto()  # plain empty → tell the model it returned nothing, re-request
