...
- `oncall-quickstart.zh-CN.md` - hands-on guide for the on-call (ops) capability:
  how to hand a long-running job to Raven, the report and decision gates, and the
  known rough edges. Chinese; research-stage feature.
