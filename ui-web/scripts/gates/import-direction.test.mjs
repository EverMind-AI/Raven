...
const PINNED = [
  ...
  'state/session/stages.ts -> features/tasks/store.ts',
...
const CROSS = [
  ...
  'features/tasks/diffs.ts -> features/workspace/hunks.ts',
  ...
  'features/transcript/source.ts -> features/tasks/store.ts',
