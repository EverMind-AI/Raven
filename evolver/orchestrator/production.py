...
from evolver.judge.llm_client import JudgeLLMBackend
from evolver.judge.parser import JudgeParseError, parse_pass_fail
from evolver.judge.prompts import build_pass_fail_messages
from evolver.orchestrator.config import Budget, OrchestratorConfig
from evolver.orchestrator.loop import (
    EvolutionOrchestrator,
    RoundResult,
    summarize_round,
)
from evolver.orchestrator.nodes.design import design_round
from evolver.orchestrator.nodes.diagnose import diagnose_round
from evolver.orchestrator.nodes.semantic import CallFn, SemanticNode
from evolver.orchestrator.nodes.verdict import draft_verdict
...
from evolver.tree.node import AppliedPatch, HarnessNode
...
def make_git_commit_apply_fn(
    ...
    *,
    ...
    from evolver.applier import assert_patch_allowed
...
def make_git_recombine_fn(repo_root: str | Path):
    ...
    """
    from evolver.orchestrator.archive import CellElite, RecombinantCandidate
    from evolver.tree import git_ops
    from evolver.tree.git_ops import GitOpError
...
def build_evolution_orchestrator(
    ...
    *,
    ...
    from evolver.orchestrator.archive import GsmeArchive
