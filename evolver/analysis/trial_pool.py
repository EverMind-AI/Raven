...
:func:`evolver.analysis.stability_bucket.compute_stability` and
the per-trial features from
:func:`evolver.analysis.proxy_features.extract_trial_dir`
into the unified :class:`Trial` view consumed by
:class:`evolver.scheduler.cold_start_bandit.ColdStartCoverageBandit`.
...
from evolver.analysis.proxy_features import (
    ExitStatus,
    ProxyFeatures,
    extract_trial_dir,
)
...
from evolver.scheduler.cold_start_bandit import Trial
