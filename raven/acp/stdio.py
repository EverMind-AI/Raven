...
from raven.agent.acp_client.protocol import AcpProtocolError, decode, encode
...
def write_frame(writer: BinaryIO, frame: dict[str, Any]) -> None:
    ...
    Encoding is :func:`raven.agent.acp_client.protocol.encode` rather than a second
